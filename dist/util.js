...
exports.getSwaggerLatestVersion = exports.downloadSwagger = void 0;
const httpm = require("@actions/http-client");
const toolCache = require("@actions/tool-cache");
const fs = require("fs");
const os = require("os");
const path = require("path");
async function downloadSwagger(toolName, version) {
...
exports.downloadSwagger = downloadSwagger;
...
function getSwaggerDownloadURL(version) {
...
async function getSwaggerLatestVersion() {
...
exports.getSwaggerLatestVersion = getSwaggerLatestVersion;
